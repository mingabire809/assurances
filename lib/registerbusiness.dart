              ...
              onTap: () async {
                ...
                await databaseReference.collection("users")
                  ...
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: (context) => ConditionBusiness()));
                });
              },
            ),
            ListTile(
...
class ConditionBusiness extends StatefulWidget{
  ...
  @override
  _ConditionBusinessState createState() => _ConditionBusinessState();
}
class _ConditionBusinessState extends State<ConditionBusiness>{
  final auth = FirebaseAuth.instance;
  void inputData() async {
    final FirebaseUser user = await auth.currentUser();
    final uid = user.uid;
