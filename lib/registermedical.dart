...
class RegisterMedical extends StatefulWidget{
  @override
  _RegisterMedicalState createState() => _RegisterMedicalState();
}
class _RegisterMedicalState extends State<RegisterMedical>{
      ...
      appBar: AppBar(
        leading: Builder(builder: (BuildContext context) {
          return IconButton(
            ...
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => Medical()));
            },
          );
        }),
        title: Text("Register"),
              ...
              onTap: () async {
                ...
                await databaseReference.collection("users")
                  ...
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: (context) => ConditionMedical()));
                });
              },
            ),
            ListTile(
...
class ConditionMedical extends StatefulWidget{
  ...
  @override
  _ConditionMedicalState createState() => _ConditionMedicalState();
}
class _ConditionMedicalState extends State<ConditionMedical>{
  final auth = FirebaseAuth.instance;
  void inputData() async {
    final FirebaseUser user = await auth.currentUser();
    final uid = user.uid;
