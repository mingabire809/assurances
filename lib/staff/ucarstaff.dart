        ...
        child: ListView(
          children:<Widget> [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.of(context).pushReplacement(MaterialPageRoute(
                    builder: (context) => UcarDisability()));
              },
            ),
            ListTile(
              leading: Icon(
...
class UcarMedical extends StatefulWidget {
  @override
  _UcarMedicalState createState() => _UcarMedicalState();
}

class _UcarMedicalState extends State<UcarMedical> {
  @override
  void initState() {
    super.initState();
      ...
      appBar: AppBar(
        leading: Builder(builder: (BuildContext context) {
          return IconButton(
            ...
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => UcarStaff()));
            },
          );
        }),
...
//load data into widgets
  ...
  getCoverList() async {
    return await Firestore.instance.collection('Cover').where("Provider", isEqualTo: "UCAR").where("Cover",isEqualTo: "Medical Cover").getDocuments();
  }
}

class UcarHouse extends StatefulWidget {
  @override
  _UcarHouseState createState() => _UcarHouseState();
}

class _UcarHouseState extends State<UcarHouse> {
  @override
  void initState() {
    super.initState();
    getCoverList().then((results) {
...
//load data into widgets
  ...
  //get firestore instance
  getCoverList() async {
    return await Firestore.instance.collection('Cover').where("Provider", isEqualTo: "UCAR").where("Cover",isEqualTo: "House Cover").getDocuments();
  }
}

class UcarCar extends StatefulWidget {
  @override
  _UcarCarState createState() => _UcarCarState();
}

class _UcarCarState extends State<UcarCar> {
  @override
  void initState() {
    super.initState();
    getCoverList().then((results) {
...
//load data into widgets
  ...
  //get firestore instance
  getCoverList() async {
    return await Firestore.instance.collection('Cover').where("Provider", isEqualTo: "UCAR").where("Cover",isEqualTo: "Car Cover").getDocuments();
  }
}

class UcarBusiness extends StatefulWidget {
  @override
  _UcarBusinessState createState() => _UcarBusinessState();
}

class _UcarBusinessState extends State<UcarBusiness> {
  @override
  void initState() {
    super.initState();
    getCoverList().then((results) {
...
//load data into widgets
  ...
  //get firestore instance
  getCoverList() async {
    return await Firestore.instance.collection('Cover').where("Provider", isEqualTo: "UCAR").where("Cover",isEqualTo: "Business Cover").getDocuments();
  }
}

class UcarDisability extends StatefulWidget {
  @override
  _UcarDisabilityState createState() => _UcarDisabilityState();
}

class _UcarDisabilityState extends State<UcarDisability> {
  @override
  void initState() {
    super.initState();
    getCoverList().then((results) {
...
//load data into widgets
  ...
  //get firestore instance
  getCoverList() async {
    return await Firestore.instance.collection('Cover').where("Provider", isEqualTo: "UCAR").where("Cover",isEqualTo: "Disability Cover").getDocuments();
  }
}

class UcarPension extends StatefulWidget {
  @override
  _UcarPensionState createState() => _UcarPensionState();
}

class _UcarPensionState extends State<UcarPension> {
  @override
  void initState() {
    super.initState();
    getCoverList().then((results) {
...
//load data into widgets
  ...
  //get firestore instance
  getCoverList() async {
    return await Firestore.instance.collection('Cover').where("Provider", isEqualTo: "UCAR").where("Cover",isEqualTo: "Pension Cover").getDocuments();
  }
}

class UcarLife extends StatefulWidget {
  @override
  _UcarLifeState createState() => _UcarLifeState();
}

class _UcarLifeState extends State<UcarLife> {
  @override
  void initState() {
    super.initState();
    getCoverList().then((results) {
...
//load data into widgets
  ...
  //get firestore instance
  getCoverList() async {
    return await Firestore.instance.collection('Cover').where("Provider", isEqualTo: "UCAR").where("Cover",isEqualTo: "Life Cover").getDocuments();
  }
}
