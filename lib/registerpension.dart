...
class RegisterPension extends StatefulWidget{
  @override
  _RegisterPensionState createState() => _RegisterPensionState();
}
class _RegisterPensionState extends State<RegisterPension>{
      ...
      appBar: AppBar(
        leading: Builder(builder: (BuildContext context) {
          return IconButton(
            ...
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => Pension()));
            },
          );
        }),
        title: Text("Register"),
              ...
              onTap: () async {
                ...
                await databaseReference.collection("users")
                  ...
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: (context) => ConditionPension()));
                });
              },
            ),
            ListTile(
...
class ConditionPension extends StatefulWidget{
  ...
  @override
  _ConditionPensionState createState() => _ConditionPensionState();
}
class _ConditionPensionState extends State<ConditionPension>{
  final auth = FirebaseAuth.instance;
  void inputData() async {
    final FirebaseUser user = await auth.currentUser();
    final uid = user.uid;
