...
class ConditionCar extends StatefulWidget{
  ...
  @override
  _ConditionCarState createState() => _ConditionCarState();
}
class _ConditionCarState extends State<ConditionCar>{
  final auth = FirebaseAuth.instance;
  void inputData() async {
    final FirebaseUser user = await auth.currentUser();
    final uid = user.uid;
