              ...
              onTap: () async {
                ...
                await databaseReference.collection("users")
                  ...
                  Navigator.of(context).pushReplacement(MaterialPageRoute(
                      builder: (context) => ConditionHouse()));
                });
              },
            ),
            ListTile(
...
class ConditionHouse extends StatefulWidget{
  ...
  @override
  _ConditionHouseState createState() => _ConditionHouseState();
}
class _ConditionHouseState extends State<ConditionHouse>{
  final auth = FirebaseAuth.instance;
  void inputData() async {
    final FirebaseUser user = await auth.currentUser();
    final uid = user.uid;
